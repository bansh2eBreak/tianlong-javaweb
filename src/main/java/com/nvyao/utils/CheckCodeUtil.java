...
public class CheckCodeUtil {
     ...
     * @throws IOException
     */
    public static String outputVerifyImage(int width, int heigth, File outputFile, int verifySize) throws IOException {
        String verifyCode = generateVerifyCode(verifySize);
        outputImage(width, heigth, outputFile, verifyCode);
        return verifyCode;
    }
